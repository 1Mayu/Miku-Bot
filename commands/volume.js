...
module.exports = {
  ...
  execute(client, message, args) {
    ...
    const sing3 = new Discord.MessageEmbed()
      .setDescription("<a:Tenor:659119222701424650>You Need To Join A Voice Channel First!")
      .setColor("#461a9b");
    return message.channel.send(sing3);
    }
    if (!serverQueue) {
    const sing4 = new Discord.MessageEmbed()
      .setDescription("<a:Tenor:659119222701424650>There Is Nothing Playing !")
      .setColor("#461a9b");
    ...
    const sing = new Discord.MessageEmbed()
      .setDescription(`<a:Up:720625241671467068>Volume Has Been Changed From **${oldVolume}%** To **${args[0]}%**`)
      .setColor("#461a9b");
    return message.channel.send(sing);
    }
    if (isNaN(args[0]) || parseInt(args[0]) > 100 || parseInt(args[0]) < 0) {
       const sing = new Discord.MessageEmbed()
      .setDescription("<a:hello:657537636461707274>You Can't Set The Volume Greater Than 100%")
      .setColor("#461a9b");
    return message.channel.send(sing);
    }
