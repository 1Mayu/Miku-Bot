...
module.exports = {
  ...
  execute(client, message, args) {
    ...
    let duration = playbackBar(message, serverQueue.songs[0])
          ...
          .setDescription (`> <a:Fire:718810829197279323>${serverQueue.songs[0].title} \`(${duration}|${serverQueue.songs[0].duration})\``)
          .setColor('#461a9b')
      ...
      setInterval(() => {
        ...
        const song = new Discord.MessageEmbed()
          .setTitle('Now playing:')
          .setDescription (`> <a:Fire:718810829197279323>${serverQueue.songs[0].title} \`(${durationnn}|${serverQueue.songs[0].duration})\``)
          .setColor('#461a9b')
           return me.edit(song)
      }, 5000);
    });
